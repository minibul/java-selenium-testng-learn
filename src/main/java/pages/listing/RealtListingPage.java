...
public class RealtListingPage extends BasePage {
    ...
    private final By card = By.xpath("//div[@role='button' and @class='cursor-pointer w-full h-full' and @aria-label='Карточка объекта в листинге']");

    public RealtListingPage checkCountCards() {
        waitElementsVisible(driver.findElement(card));
